...
{
    public class rptDiseaseOutbreakDataMap : EntityTypeConfiguration<rptDiseaseOutbreakData>
    {
        public rptDiseaseOutbreakDataMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Id, t.Year, t.Month, t.Region, t.Zone, t.Woreda, t.Disease, t.Species, t.LocationId });
            ...
            this.ToTable("rptDiseaseOutbreakData");
