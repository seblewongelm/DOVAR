...
{
    public class rptDovarAreaCoverageByZoneMap : EntityTypeConfiguration<rptDovarAreaCoverageByZone>
    {
        public rptDovarAreaCoverageByZoneMap()
        {
            // Primary Key
            ...
            this.ToTable("rptDovarAreaCoverageByZone");
