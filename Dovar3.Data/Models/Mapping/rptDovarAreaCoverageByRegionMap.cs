...
{
    public class rptDovarAreaCoverageByRegionMap : EntityTypeConfiguration<rptDovarAreaCoverageByRegion>
    {
        public rptDovarAreaCoverageByRegionMap()
        {
            // Primary Key
            ...
            this.ToTable("rptDovarAreaCoverageByRegion");
