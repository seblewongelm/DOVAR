...
{
    public class rptReportingPerformanceByRVL2Map : EntityTypeConfiguration<rptReportingPerformanceByRVL2>
    {
        public rptReportingPerformanceByRVL2Map()
        {
            // Primary Key
            ...
            this.ToTable("rptReportingPerformanceByRVL2");
