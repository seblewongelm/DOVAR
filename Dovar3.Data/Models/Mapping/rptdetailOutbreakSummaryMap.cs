...
{
    public class rptdetailOutbreakSummaryMap : EntityTypeConfiguration<rptdetailOutbreakSummary>
    {
        public rptdetailOutbreakSummaryMap()
        {
            // Primary Key
            ...
            this.ToTable("rptdetailOutbreakSummary");
