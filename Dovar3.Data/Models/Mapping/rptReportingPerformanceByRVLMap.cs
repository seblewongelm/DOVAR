...
{
    public class rptReportingPerformanceByRVLMap : EntityTypeConfiguration<rptReportingPerformanceByRVL>
    {
        public rptReportingPerformanceByRVLMap()
        {
            // Primary Key
            ...
            this.ToTable("rptReportingPerformanceByRVL");
