...
{
    public class rptReportingNonReportingWoredaMap : EntityTypeConfiguration<rptReportingNonReportingWoreda>
    {
        public rptReportingNonReportingWoredaMap()
        {
            // Primary Key
            ...
            this.ToTable("rptReportingNonReportingWoredas");
