...
{
    public class rptAreaCoverageByZone1Map : EntityTypeConfiguration<rptAreaCoverageByZone1>
    {
        public rptAreaCoverageByZone1Map()
        {
            // Primary Key
            ...
            this.ToTable("rptAreaCoverageByZone1");
